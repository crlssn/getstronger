...
type preloaders struct {
	...
	ExerciseRoutine exerciseRoutinePreloader
...
func getPreloaders() preloaders {
	return preloaders{
		...
		ExerciseRoutine: buildExerciseRoutinePreloader(),
...
type thenLoaders[Q orm.Loadable] struct {
	...
	ExerciseRoutine exerciseRoutineThenLoader[Q]
...
func getThenLoaders[Q orm.Loadable]() thenLoaders[Q] {
	return thenLoaders[Q]{
		...
		ExerciseRoutine: buildExerciseRoutineThenLoader[Q](),
