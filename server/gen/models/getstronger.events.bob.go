...
type Event struct {
	ID        string                      `db:"id,pk" `
	Topic     enums.GetstrongerEventTopic `db:"topic" `
...
var Events = psql.NewTablex[*Event, EventSlice, *EventSetter]("getstronger", "events", buildEventColumns("getstronger.events"), eventScanMapper)
...
type EventSetter struct {
	...
	Topic     omit.Val[enums.GetstrongerEventTopic] `db:"topic" `
...
func (o *Event) pkEQ() dialect.Expression {
	return psql.Quote("getstronger.events", "id").EQ(bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
...
func (o EventSlice) pkIN() dialect.Expression {
	...
	return psql.Quote("getstronger.events", "id").In(bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
...
type eventWhere[Q psql.Filterable] struct {
	...
	Topic     psql.WhereMod[Q, enums.GetstrongerEventTopic]
...
func buildEventWhere[Q psql.Filterable](cols eventColumns) eventWhere[Q] {
	return eventWhere[Q]{
		...
		Topic:     psql.Where[Q, enums.GetstrongerEventTopic](cols.Topic.Expression),
