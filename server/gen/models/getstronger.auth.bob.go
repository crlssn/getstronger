...
var Auths = psql.NewTablex[*Auth, AuthSlice, *AuthSetter]("getstronger", "auth", buildAuthColumns("getstronger.auth"), authScanMapper)
...
type authR struct {
	User *User // getstronger.users.users_auth_id_fkey
...
type authRLoaded struct {
	User bool // getstronger.users.users_auth_id_fkey
}
...
func (o *Auth) pkEQ() dialect.Expression {
	return psql.Quote("getstronger.auth", "id").EQ(bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
...
func (o AuthSlice) pkIN() dialect.Expression {
	...
	return psql.Quote("getstronger.auth", "id").In(bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
