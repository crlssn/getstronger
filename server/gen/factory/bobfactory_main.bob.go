...
func (f *Factory) fromExistingUser(ctx context.Context, m *models.User) *UserTemplate {
	...
	o.AutofillSets = func() bool { return m.AutofillSets }
	o.FeedSeenAt = func() null.Val[time.Time] { return m.FeedSeenAt }
	o.AutoPause = func() bool { return m.AutoPause }
...
func (f *Factory) fromExistingWorkout(ctx context.Context, m *models.Workout) *WorkoutTemplate {
	...
	o.RecordingKey = func() string { return m.RecordingKey }
