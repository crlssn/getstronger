...
const file_api_v1_shared_proto_rawDesc = "" +
	...
	"\fExerciseSets\x124\n" +
	"\bexercise\x18\x01 \x01(\v2\x10.api.v1.ExerciseB\x06\xbaH\x03\xc8\x01\x01R\bexercise\x12)\n" +
	"\x04sets\x18\x02 \x03(\v2\v.api.v1.SetB\b\xbaH\x05\x92\x01\x02\b\x01R\x04sets\"\xdc\x01\n" +
	"\bExercise\x12\x18\n" +
	...
	"\rpersonal_best\x18\x03 \x01(\bR\fpersonalBest\"\xf8\x02\n" +
	"\x04User\x12\x18\n" +
	"\x02id\x18\x01 \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01R\x02id\x12\x1d\n" +
	"\x04name\x18\b \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dR\x04name\x12\x1a\n" +
	...
	"\x14EXERCISE_METRIC_TIME\x10\x04*w\n" +
