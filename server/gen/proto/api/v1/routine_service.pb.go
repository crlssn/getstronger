...
type RoutineGroup struct {
	...
	Role RoutineGroupRole `protobuf:"varint,9,opt,name=role,proto3,enum=api.v1.RoutineGroupRole" json:"role,omitempty"`
...
func (x *RoutineGroup) GetRole() RoutineGroupRole {
	if x != nil {
		return x.Role
	}
...
func (x *RoutineGroup) GetSkipLastOnFinalRound() bool {
	if x != nil {
...
const file_api_v1_routine_service_proto_rawDesc = "" +
	"\n" +
	"\x1capi/v1/routine_service.proto\x12\x06api.v1\x1a\x13api/v1/shared.proto\x1a\x1capi/v1/workout_service.proto\x1a\x1bbuf/validate/validate.proto\"\x99\x01\n" +
	"\x14CreateRoutineRequest\x12\x1d\n" +
	...
	"\x15DeleteRoutineResponse\"u\n" +
	"\x13ListRoutinesRequest\x12\x1b\n" +
	"\x04name\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x18dR\x04name\x12A\n" +
	"\n" +
	...
	"\x12distance_this_week\x18\t \x01(\x01R\x10distanceThisWeek\"\xaa\x01\n" +
	"\aRoutine\x12\x18\n" +
	...
	"\x05plans\x18\x01 \x03(\v2\f.api.v1.PlanR\x05plans\"\x82\x01\n" +
	"\x11UpdatePlanRequest\x12\x18\n" +
	"\x02id\x18\x01 \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01R\x02id\x12\x1d\n" +
	"\x04name\x18\x02 \x01(\tB\t\xbaH\x06r\x04\x10\x01\x18dR\x04name\x124\n" +
	...
	"\x04plan\x18\x01 \x01(\v2\f.api.v1.PlanR\x04plan\"\xc2\x01\n" +
	"\x04Plan\x12\x18\n" +
	"\x02id\x18\x01 \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01R\x02id\x12\x1d\n" +
