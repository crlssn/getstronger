...
import type { Exercise, ExerciseSet, PaginationRequest, PaginationResponse, RoutineGroupMode, RoutineGroupRole } from "./shared_pb";
...
export const file_api_v1_routine_service: GenFile = /*@__PURE__*/
  fileDesc("", [file_api_v1_shared, file_api_v1_workout_service, file_buf_validate_validate]);
...
export type GetDashboardResponse = Message<"api.v1.GetDashboardResponse"> & {
   ...
   *
   * @generated from field: double distance_this_week = 9;
   */
...
export type RoutineGroup = Message<"api.v1.RoutineGroup"> & {
   ...
   *
   * @generated from field: api.v1.RoutineGroupRole role = 9;
   */
   ...
   *
   * @generated from field: bool skip_last_on_final_round = 10;
   */
...
export type RoutineExercise = Message<"api.v1.RoutineExercise"> & {
   ...
   *
   * @generated from field: int32 target_duration_seconds = 3;
   */
   ...
   *
   * @generated from field: api.v1.RoutineExerciseTracking tracking = 4;
   */
   ...
   *
   * @generated from field: int32 sets = 5;
   */
  sets: number;
   ...
   *
   * @generated from field: int32 target_distance_meters = 6;
   */
 ...
 *
 * @generated from enum api.v1.RoutineExerciseTracking
 */
export enum RoutineExerciseTracking {
  /**
   * @generated from enum value: ROUTINE_EXERCISE_TRACKING_UNSPECIFIED = 0;
   */
  UNSPECIFIED = 0,

  /**
   * @generated from enum value: ROUTINE_EXERCISE_TRACKING_SETS = 1;
   */
  SETS = 1,

  /**
   * @generated from enum value: ROUTINE_EXERCISE_TRACKING_TIMED = 2;
   */
  TIMED = 2,

  /**
   * @generated from enum value: ROUTINE_EXERCISE_TRACKING_DISTANCE = 3;
   */
  DISTANCE = 3,
}

/**
 * Describes the enum api.v1.RoutineExerciseTracking.
 */
export const RoutineExerciseTrackingSchema: GenEnum<RoutineExerciseTracking> = /*@__PURE__*/
