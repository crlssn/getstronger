...
| Area                     | Rules                              | Covers                                        |
| ------------------------ | ---------------------------------- | --------------------------------------------- |
| `server/` (Go backend)   | [`server/AGENTS.md`](server/AGENTS.md)     | Error handling, log messages, layering  |
| `web/` (Vue web app)     | [`web/AGENTS.md`](web/AGENTS.md)           | Localisation, components, design review |
| `database/`              | [`database/AGENTS.md`](database/AGENTS.md) | Migrations, seeding, generated models   |
| `proto/`                 | [`proto/AGENTS.md`](proto/AGENTS.md)       | Schema changes and code generation      |
| `mobile/`                | [`mobile/AGENTS.md`](mobile/AGENTS.md)     | Capacitor wrappers and native builds    |
