...
var file_api_v1_workouts_proto_rawDesc = []byte{
	...
	0x75, 0x74, 0x52, 0x07, 0x77, 0x6f, 0x72, 0x6b, 0x6f, 0x75, 0x74, 0x22, 0x85, 0x01, 0x0a, 0x07,
	...
	0x04, 0x72, 0x65, 0x70, 0x73, 0x32, 0xea, 0x01, 0x0a, 0x0e, 0x57, 0x6f, 0x72, 0x6b, 0x6f, 0x75,
	...
	0x18, 0x01, 0x42, 0x94, 0x01, 0x0a, 0x0a, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76,
	...
	0x72, 0x2f, 0x61, 0x70, 0x70, 0x73, 0x2f, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x2f, 0x70,
...
var file_api_v1_workouts_proto_depIdxs = []int32{
	...
	7, // 4: api.v1.Workout.exercise_sets:type_name -> api.v1.ExerciseSets
	8, // 5: api.v1.ExerciseSets.sets:type_name -> api.v1.Set
	0, // 6: api.v1.WorkoutService.Create:input_type -> api.v1.CreateWorkoutRequest
	4, // 7: api.v1.WorkoutService.Get:input_type -> api.v1.GetWorkoutRequest
	2, // 8: api.v1.WorkoutService.List:input_type -> api.v1.ListWorkoutsRequest
	1, // 9: api.v1.WorkoutService.Create:output_type -> api.v1.CreateWorkoutResponse
	5, // 10: api.v1.WorkoutService.Get:output_type -> api.v1.GetWorkoutResponse
	3, // 11: api.v1.WorkoutService.List:output_type -> api.v1.ListWorkoutsResponse
