...
var file_api_v1_workouts_proto_rawDesc = []byte{
	...
	0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x85, 0x01, 0x0a, 0x07, 0x57, 0x6f, 0x72, 0x6b, 0x6f,
	...
	0x32, 0xa6, 0x01, 0x0a, 0x0e, 0x57, 0x6f, 0x72, 0x6b, 0x6f, 0x75, 0x74, 0x53, 0x65, 0x72, 0x76,
	...
	0x12, 0x47, 0x0a, 0x04, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x1b, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76,
	...
	0x6d, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x42, 0x0d, 0x57, 0x6f, 0x72, 0x6b, 0x6f, 0x75,
	...
	0x73, 0x74, 0x72, 0x6f, 0x6e, 0x67, 0x65, 0x72, 0x2f, 0x61, 0x70, 0x70, 0x73, 0x2f, 0x62, 0x61,
	0x63, 0x6b, 0x65, 0x6e, 0x64, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x70, 0x62, 0x2f, 0x61, 0x70, 0x69,
...
var file_api_v1_workouts_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_api_v1_workouts_proto_goTypes = []any{
	...
	(*Workout)(nil),               // 4: api.v1.Workout
	(*ExerciseSets)(nil),          // 5: api.v1.ExerciseSets
	(*Set)(nil),                   // 6: api.v1.Set
}
var file_api_v1_workouts_proto_depIdxs = []int32{
	5, // 0: api.v1.CreateWorkoutRequest.exercise_sets:type_name -> api.v1.ExerciseSets
	4, // 1: api.v1.ListWorkoutsResponse.workouts:type_name -> api.v1.Workout
	5, // 2: api.v1.Workout.exercise_sets:type_name -> api.v1.ExerciseSets
	6, // 3: api.v1.ExerciseSets.sets:type_name -> api.v1.Set
	0, // 4: api.v1.WorkoutService.Create:input_type -> api.v1.CreateWorkoutRequest
	2, // 5: api.v1.WorkoutService.List:input_type -> api.v1.ListWorkoutsRequest
	1, // 6: api.v1.WorkoutService.Create:output_type -> api.v1.CreateWorkoutResponse
	3, // 7: api.v1.WorkoutService.List:output_type -> api.v1.ListWorkoutsResponse
