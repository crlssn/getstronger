...
<template>
  <div class="divide-y divide-gray-200 overflow-hidden rounded-lg bg-white shadow mb-4">
    <div class="px-4 py-4 sm:px-6">
      <span class="font-semibold">Create Exercise</span>
    </div>
    <div class="px-4 py-4 sm:px-6">
      <div v-if="resOK" class="bg-green-200 rounded-md py-3 px-5 mb-2 text-sm/6 text-green-800" role="alert">Exercise
        created
      </div>
      ...
      <form class="space-y-6" method="POST" @submit.prevent="createExercise">
        <div>
