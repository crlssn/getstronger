...
import { AuthService } from '@/proto/api/v1/auth_connect'
import { ExerciseService } from '@/proto/api/v1/exercise_connect'
import { auth, logger } from '@/clients/interceptors'
import { RoutineService } from '@/proto/api/v1/routines_connect'
import { WorkoutService } from '@/proto/api/v1/workouts_connect'
