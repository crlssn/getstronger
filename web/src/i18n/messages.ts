export const en = {
  ...
  profile: {
    ...
    paceTonesBody: 'Which recorded session an interval is compared with while you record',
    paceTonesPrevious: 'Last',
    paceTonesBest: 'Best',
...
export const sv = {
  ...
  timedCircuit: {
    ...
    paceNow: 'Tempo nu',
    noPace: '—',
    lastInterval: 'Senaste · {name} {round}',
  ...
  profile: {
    ...
    paceTones: 'Tempoljud',
    paceTonesBody: 'Vilket registrerat pass ett intervall jämförs med under inspelning',
    paceTonesPrevious: 'Senaste',
    paceTonesBest: 'Bästa',
