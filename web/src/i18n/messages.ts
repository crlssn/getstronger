  ...
  routine: {
    ...
    form: {
      ...
      intervals: {
        ...
        roundsBody_one: '{names}, once through',
        roundsBody_other: '{names}, {count} times through',
        roundsEmpty: 'Nothing to repeat yet',
        skip: 'Skip last exercise on final round',
        skipOn: 'The last round ends on {name}, without the {dropped}',
        skipOff: 'Every round runs in full',
        planned_one: '{count} min planned',
        planned_other: '{count} min planned',
        untimed: 'No times set yet',
        count_one: '{count} interval',
        count_other: '{count} intervals',
      },
      groups: {
        section: 'How it runs',
        shapeSimple: 'Standard',
        shapeGroups: 'Groups',
        shapeIntervals: 'Intervals',
        simpleHint: 'One list of exercises, done top to bottom.',
        groupsHint: 'Order exercises into groups, each with its own style of rest.',
        intervalsHint:
          'A warm-up, one block repeated, and a cool-down, read straight through when finished.',
  ...
  routine: {
    ...
    form: {
      ...
      intervals: {
        ...
        roundsBody_one: '{names}, ett varv',
        roundsBody_other: '{names}, {count} varv',
        roundsEmpty: 'Inget att upprepa ännu',
        skip: 'Hoppa över sista övningen på sista varvet',
        skipOn: 'Sista varvet slutar med {name}, utan {dropped}',
        skipOff: 'Varje varv körs fullt ut',
        planned_one: '{count} min planerat',
        planned_other: '{count} min planerat',
        untimed: 'Inga tider satta ännu',
        count_one: '{count} intervall',
        count_other: '{count} intervall',
      },
      groups: {
        section: 'Upplägg',
        shapeSimple: 'Standard',
        shapeGroups: 'Grupper',
        shapeIntervals: 'Intervaller',
        simpleHint: 'En lista med övningar, uppifrån och ner.',
        groupsHint: 'Dela in övningarna i grupper, var och en med sin egen vila.',
        intervalsHint: 'Uppvärmning, ett block som upprepas och nedvarvning, i en följd.',
        groupName: 'Grupp {letter}',
        modeAria: 'Upplägg för grupp {letter}',
        straight: 'Raka set',
        circuit: 'Cirkel',
        straightSummary: 'Alla set på en övning innan nästa.',
        circuitSummary: 'Ett set av varje övning, sedan om från början.',
        rounds: 'Varv',
        roundsAny: 'Fritt',
        roundsAria: 'Varv',
        ...
        roundsOpen: 'Så många varv du vill',
        restTimers: 'Vilotimer',
        restTimersAria: 'Vilotimer i grupp {letter}',
        restTimersHint: 'Mellan set och efter varje övning',
        ...
        restSetCaption: 'Setvila',
        target: 'Hålls i',
        targetAria: 'Tidsmål för {name}',
        targetChip: 'Tidsmål för {name}: {value}',
        targetCaption: 'Tid',
        targetOff: 'Av',
        addGroup: 'Ny grupp',
