...
export const sv = {
  ...
  routine: {
    ...
    form: {
      ...
      intervals: {
        ...
        cooldownBadge: 'N',
        repeatBadge: '×{count}',
        warmupNote: 'En gång, före räkningen',
        cooldownNote: 'En gång, efter räkningen',
        repeatNote: 'Sägs som Varv n av {count}',
        ...
        skipOn: 'Sista varvet slutar på {name}, utan {dropped}',
      ...
      groups: {
        ...
        intervalsHint:
          'En uppvärmning, ett block som upprepas och en nedvarvning, som läses rakt igenom när passet är klart.',
  ...
  profile: {
    ...
    autoPauseBody: 'Håller registreringen vid övergångsställen och släpper när du rör dig igen',
  ...
  settings: {
    ...
    paceTones: 'Tempoljud',
    paceTonesIntro:
      'En ton i örat när ett intervall drar ifrån eller halkar efter ett av dina egna pass med rutinen. Det sparas bara på den här enheten.',
    paceTonesOff: 'Av',
    paceTonesOffBody: 'Registreras utan jämförelse',
    paceTonesPrevious: 'Senaste passet',
    paceTonesPreviousBody: 'Mot din senaste registrering',
    paceTonesBest: 'Bästa passet',
    paceTonesBestBody: 'Mot din snabbaste registrering',
    account: 'Konto',
