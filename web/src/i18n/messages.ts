export const en = {
  ...
  timedCircuit: {
    ...
    pausedLabel: 'Paused',
    pausedAuto: 'Paused because you stopped — movement is not recorded',
    pausedAutoLabel: 'Auto-paused',
    pausedFor: 'Paused for {time}',
    gps: 'GPS',
    gpsGood: 'GPS tracking',
    gpsPoor: 'Waiting for accurate GPS — distance may be incomplete',
    volumeAction: 'Voice volume: {level}. Tap to change',
    volumeFull: 'Full',
    volumeLow: 'Low',
    volumeOff: 'Off',
    intervalLeft: 'Interval left',
    elapsed: 'Elapsed {time}',
    nowOnly: '{name} {duration}',
    nowThenNext: '{name} {duration} · then {next} {nextDuration}',
    paceNow: 'Pace now',
    speedNow: 'Speed',
    noPace: '—',
    ...
    intervals: 'Intervals',
    interval: 'Interval',
    intervalPosition: 'Interval {position}',
    averagePace: 'Average pace',
    sequence: 'Sequence',
    pace: 'Pace',
    timeAndDistance: 'Time · {unit}',
    prescriptionBlock: '{count} × ({intervals})',
  },
  common: {
    cancel: 'Cancel',
    close: 'Close',
  ...
  notifications: {
    ...
    emptyBody: 'New follows, comments and reps on your workouts land here.',
    followedYou: '{name} followed you',
    reppedYourWorkout: '{name} repped your {workout} workout',
  ...
  workout: {
    ...
    workoutsCompact_one: '{count} workout',
    workoutsCompact_other: '{count} workouts',
    ...
    card: {
      ...
      rep_one: 'Rep this workout, {count} rep',
      rep_other: 'Rep this workout, {count} reps',
      unrep_one: 'Remove your rep, {count} rep',
      unrep_other: 'Remove your rep, {count} reps',
      comments: 'Comments',
  ...
  routine: {
    ...
    form: {
      ...
      intervals: {
        ...
        cooldownBadge: 'C',
        repeatBadge: '×{count}',
        warmupNote: 'Once, before the count',
        cooldownNote: 'Once, after the count',
        repeatNote: 'Announced as Round n of {count}',
      },
      blocks: {
        startTitle: 'Start from',
        startBody:
          'A starting shape, not a mode. Every routine is a list of blocks you can change afterwards.',
        startBlank: 'Blank — one list, top to bottom',
        startCircuit: 'Circuit — one block, repeated',
        startIntervals: 'Intervals — warm-up, repeat, cool-down',
        blockName: 'Block {letter}',
        eyebrow: 'Block',
        settings: 'Block settings: {title}',
        straight: 'Straight',
        circuit: 'Circuit',
        straightMeta: 'All sets of one exercise, then the next',
        circuitMeta_one: 'One set of each, once through',
        circuitMeta_other: 'One set of each, {count} times through',
        circuitMetaOpen: 'One set of each, for as many rounds as you take',
        roundsTile: '×{count}',
        roundsTileOpen: 'Any',
        rest: '{value} rest',
        noRest: 'No rest',
        ...
        exerciseSettings: 'Exercise settings: {name}',
        setsChip_one: '{count} set',
        setsChip_other: '{count} sets',
        timed: 'Timed',
        distance: 'Distance',
        plannedNone: 'Nothing planned yet',
        planned_one: '≈ {count} min planned',
        planned_other: '≈ {count} min planned',
        intervals_one: '{count} interval',
        intervals_other: '{count} intervals',
        nameLabel: 'Block name',
        style: 'Style',
        straightLead: 'All sets of one exercise before the next.',
        circuitLead: 'One set of each exercise, then back to the top.',
        rounds: 'Rounds',
        roundsAny: 'Any',
        roundsBody_one: 'Worked through once',
        roundsBody_other: 'Worked through {count} times',
        roundsBodyOpen: 'Worked through for as many rounds as you take',
        roundsDecrease: 'Subtract a round from {label}',
        roundsIncrease: 'Add a round to {label}',
        restExercise: 'Rest after each exercise',
        restRound: 'Rest after each round',
        restBody: '0:00 means no timer',
        skip: 'Skip last exercise on final round',
        skipOn: 'The final round stops one exercise early',
        skipOff: 'Every round runs in full',
        trackedAs: 'Tracked as',
        sets: 'Sets',
        setsLead: 'Counted in sets, with rest between them.',
        timedLead: 'Ends when the clock runs out.',
        distanceLead: 'Ends when the distance is covered; no timer.',
        setsDecrease: 'Subtract a set from {label}',
        setsIncrease: 'Add a set to {label}',
        restSets: 'Rest between sets',
        heldFor: 'Held for',
        targetDistance: 'Target distance',
        targetDistanceBody: 'Ends when covered, however long it takes',
        distanceDecrease: 'Shorter distance',
        distanceIncrease: 'Longer distance',
        removeExerciseAction: 'Remove exercise',
      },
    },
    view: {
  ...
  profile: {
    ...
    autoPause: 'Pause while I stand still',
  ...
  settings: {
    ...
    paceTonesBestBody: 'Against your fastest recording',
    account: 'Account',
...
export const sv = {
  ...
  timedCircuit: {
    ...
    gpsPoor: 'Väntar på stabil GPS-signal — distansen kan bli ofullständig',
    volumeAction: 'Röstvolym: {level}. Tryck för att ändra',
    volumeFull: 'Full',
    volumeLow: 'Låg',
    volumeOff: 'Av',
    intervalLeft: 'Kvar av intervallet',
    elapsed: 'Tid {time}',
    nowOnly: '{name} {duration}',
    nowThenNext: '{name} {duration} · sedan {next} {nextDuration}',
    paceNow: 'Tempo nu',
    speedNow: 'Hastighet',
    noPace: '—',
    ...
    interval: 'Intervall',
    intervalPosition: 'Intervall {position}',
    averagePace: 'Snittempo',
    sequence: 'Ordning',
    pace: 'Tempo',
    timeAndDistance: 'Tid · {unit}',
    prescriptionBlock: '{count} × ({intervals})',
  },
  common: {
    cancel: 'Avbryt',
  ...
  home: {
    ...
    createFirstRoutineBody:
      'Bygg ett pass du kan träna om och om igen och börja följa dina framsteg.',
    ...
    emptyFeed: 'Följ någon så dyker deras träningspass upp här när de har tränat.',
    emptyFeedAction: 'Hitta personer',
    caughtUp: 'Du är ikapp',
  ...
  notifications: {
    ...
    emptyBody: 'Nya följare, kommentarer och repp på dina träningspass visas här.',
    followedYou: '{name} började följa dig',
    reppedYourWorkout: '{name} reppade ditt träningspass {workout}',
  ...
  workout: {
    ...
    heading: 'Träna',
    subtitle: 'Starta ditt planerade pass eller träna fritt.',
    discard: 'Ta bort träningspasset',
    quick: 'Snabbpass',
    quickBody: 'Bygg passet medan du tränar · flyttar inte fram planen',
    ...
    workoutsCompact_one: '{count} pass',
    workoutsCompact_other: '{count} pass',
    durationPlaceholder: 'm:ss',
    restTimer: 'Vilotimer',
    ...
    saveFailed: 'Träningspasset kunde inte sparas. Kontrollera din anslutning och försök igen.',
    savedWithoutId:
      'Träningspasset sparades men saknar id. Ladda om dina träningspass för att öppna det.',
    savedNotOpened:
      'Träningspasset sparades men kunde inte öppnas. Tryck på Avsluta träningspass för att försöka igen.',
    quickWorkoutUnavailable: 'Starta om servern för att aktivera snabbpass och försök igen.',
    ...
    historyUndated: 'Utan datum',
    autosaved: 'Automatiskt sparat',
    leaveBody:
      'Dina framsteg sparas på den här enheten. Fortsätt när som helst via bannern för pågående träningspass.',
    ...
    card: {
      ...
      rep_one: 'Reppa det här passet, {count} repp',
      rep_other: 'Reppa det här passet, {count} repp',
      unrep_one: 'Ta bort ditt repp, {count} repp',
      unrep_other: 'Ta bort ditt repp, {count} repp',
  ...
  training: {
    ...
    repeatingTitle: 'Sätt ihop passen i en ordning som upprepas',
    ...
    keepTraining: 'Fortsätt träna',
    keepTrainingBody: 'Ordningen upprepas tills du pausar planen.',
    ...
    activateConfirmBody: 'Din nuvarande plan pausas där den är.',
    pauseConfirmTitle: 'Pausa planen?',
    pauseConfirmBody: 'Planen fortsätter där den är när du aktiverar den igen.',
    ...
    routineCountSequence_one: '{count} pass · upprepas i ordning',
    routineCountSequence_other: '{count} pass · upprepas i ordning',
    noMatchingRoutines: 'Inga matchande pass',
    noRoutines: 'Inga pass ännu',
    planForm: {
      editTitle: 'Redigera plan',
      intro: 'Välj dina pass en gång. Planen upprepar dem i den här ordningen, om och om igen.',
      name: 'Planens namn',
      namePlaceholder: 't.ex. Styrkerotation',
      loopNote:
        'Inga datum, veckor eller slutdatum. Varje genomfört träningspass flyttar planen ett steg framåt.',
      editNote:
        'Passet som står på tur fortsätter att göra det om det finns kvar i den nya ordningen.',
      routineCount_one: '{count} pass',
      routineCount_other: '{count} pass',
      emptyBody: 'Det första passet du lägger till blir planens start.',
      reorder: 'Ändra ordning på {name}',
      remove: 'Ta bort {name}',
      addRoutine: 'Lägg till pass',
      loopFooter: 'Efter {last} börjar planen om med {first}.',
      saveNoteEditing: 'Planen fortsätter som förut, från samma position.',
      saveNoteNew: 'Nya planer är inaktiva från början, så Nästa pass ändras inte.',
      saving: 'Sparar…',
    ...
    planView: {
      ...
      emptyBody: 'Alla pass i planen har tagits bort. Redigera planen för att lägga till ett.',
  ...
  routine: {
    ...
    form: {
      ...
      intervals: {
        ...
        cooldownBadge: 'N',
        repeatBadge: '×{count}',
        warmupNote: 'En gång, före varven',
        cooldownNote: 'En gång, efter varven',
        repeatNote: 'Läses upp som ”Varv n av {count}”',
      },
      blocks: {
        startTitle: 'Börja med',
        startBody:
          'En utgångspunkt, inte ett läge. Varje pass är en lista med block som du kan ändra efteråt.',
        startBlank: 'Tomt — en lista, uppifrån och ner',
        startCircuit: 'Cirkel — ett block som upprepas',
        startIntervals: 'Intervaller — uppvärmning, upprepning, nedvarvning',
        blockName: 'Block {letter}',
        eyebrow: 'Block',
        settings: 'Blockinställningar: {title}',
        straight: 'Raka set',
        circuit: 'Cirkel',
        straightMeta: 'Alla set på en övning, sedan nästa',
        circuitMeta_one: 'Ett set av varje, ett varv',
        circuitMeta_other: 'Ett set av varje, {count} varv',
        circuitMetaOpen: 'Ett set av varje, så många varv du vill',
        roundsTile: '×{count}',
        roundsTileOpen: 'Fritt',
        rest: '{value} vila',
        noRest: 'Ingen vila',
        ...
        exerciseSettings: 'Övningsinställningar: {name}',
        setsChip_one: '{count} set',
        setsChip_other: '{count} set',
        timed: 'Tid',
        distance: 'Distans',
        plannedNone: 'Inget planerat ännu',
        planned_one: '≈ {count} min planerat',
        planned_other: '≈ {count} min planerat',
        intervals_one: '{count} intervall',
        intervals_other: '{count} intervall',
        nameLabel: 'Blockets namn',
        style: 'Upplägg',
        straightLead: 'Alla set på en övning innan nästa.',
        circuitLead: 'Ett set av varje övning, sedan om från början.',
        rounds: 'Varv',
        roundsAny: 'Fritt',
        roundsBody_one: 'Körs ett varv',
        roundsBody_other: 'Körs {count} varv',
        roundsBodyOpen: 'Körs så många varv du vill',
        roundsDecrease: 'Dra bort ett varv från {label}',
        roundsIncrease: 'Lägg till ett varv till {label}',
        restExercise: 'Vila efter varje övning',
        restRound: 'Vila efter varje varv',
        restBody: '0:00 betyder ingen timer',
        skip: 'Hoppa över sista övningen på sista varvet',
        skipOn: 'Sista varvet slutar en övning tidigare',
        skipOff: 'Varje varv körs fullt ut',
        trackedAs: 'Mäts som',
        sets: 'Set',
        setsLead: 'Räknas i set, med vila emellan.',
        timedLead: 'Slutar när tiden är ute.',
        distanceLead: 'Slutar när distansen är avklarad; ingen timer.',
        setsDecrease: 'Dra bort ett set från {label}',
        setsIncrease: 'Lägg till ett set till {label}',
        restSets: 'Vila mellan set',
        heldFor: 'Hålls i',
        targetDistance: 'Distansmål',
        targetDistanceBody: 'Slutar när den är avklarad, hur lång tid det än tar',
        distanceDecrease: 'Kortare distans',
        distanceIncrease: 'Längre distans',
        removeExerciseAction: 'Ta bort övning',
      },
    },
    view: {
      orderTitle: 'Övningsordning',
      orderHelp: 'Dra i handtaget för att ändra ordningen.',
      groupedOrderHelp: 'Ordningen i grupperade pass ändrar du på redigeringssidan.',
  ...
  exercise: {
    ...
    replaceWorkoutConfirmTitle: 'Avsluta ”{workout}” utan att spara?',
    replaceWorkoutConfirmBody:
      'Alla loggade set i det pågående träningspasset tas bort och ett snabbpass med ”{exercise}” startas.',
  ...
  profile: {
    ...
    publicProfileBody: 'Så ser andra din profil',
  ...
  settings: {
    ...
    intervalCueOff: 'Av',
    intervalCueOffBody: 'Intervallen tar slut utan förvarning',
    intervalCueLead_one: '{count} sekund före slutet',
    intervalCueLead_other: '{count} sekunder före slutet',
    ...
    paceTonesBestBody: 'Jämför med ditt snabbaste pass',
    account: 'Konto',
    accountBody: 'Dina uppgifter, ditt lösenord och hur du tar bort kontot',
    accountIntro: 'Uppgifterna som hör till kontot, och hur du tar bort det.',
  ...
  streak: {
    ...
    stillNeeded: 'ett träningspass behövs den här veckan',
    outsideStreak: 'utanför din streak',
