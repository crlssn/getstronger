export const en = {
  ...
  auth: {
    brandTagline: 'Track your training. Beat your last.',
    welcomeBack: 'Welcome back',
    loginTitle: 'Log in to One More Rep',
    loginSubtitle: 'Pick up your training exactly where you left off.',
    email: 'Email address',
    password: 'Password',
    forgotPassword: 'Forgot password?',
    login: 'Log in',
    newMember: 'New to One More Rep?',
...
export const sv = {
  ...
  auth: {
    brandTagline: 'Följ din träning. Slå ditt senaste.',
    welcomeBack: 'Välkommen tillbaka',
    loginTitle: 'Logga in på One More Rep',
    loginSubtitle: 'Fortsätt träningen precis där du slutade.',
    email: 'E-postadress',
    password: 'Lösenord',
    forgotPassword: 'Glömt lösenordet?',
    login: 'Logga in',
    newMember: 'Ny på One More Rep?',
