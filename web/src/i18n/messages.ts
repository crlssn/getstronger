  ...
  routine: {
    ...
    form: {
      ...
      groups: {
        ...
        restSummarySets: '{duration} between sets',
        restSummaryExercise: '{duration} after each exercise',
        restSummaryRound: '{duration} after each round',
        restVaries: 'Varies',
        ...
        moveToGroup: 'Move to group {letter}',
  ...
  routine: {
    ...
    form: {
      ...
      groups: {
        ...
        restSummarySets: '{duration} mellan set',
        restSummaryExercise: '{duration} efter varje övning',
        restSummaryRound: '{duration} efter varje varv',
        restVaries: 'Varierar',
        ...
        entryActions: 'Åtgärder för {name}',
        moveToGroup: 'Flytta till grupp {letter}',
