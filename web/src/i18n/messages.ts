export const en = {
  ...
  auth: {
    ...
    weightUnitHelp: 'New workout sets will start with this unit. You can switch any set.',
    kilograms: 'Kilograms',
    pounds: 'Pounds',
...
export const sv = {
  ...
  auth: {
    ...
    weightUnitHelp: 'Nya träningsset börjar med denna enhet. Du kan byta för varje set.',
    kilograms: 'Kilogram',
    pounds: 'Pund',
